...
# Writes
kairos call create_task '{"title":"Follow up with Acme","status":"todo","priority":"high","dueAt":"2026-07-15T17:00:00.000Z"}'
...
kairos call create_task '{"title":"Clean water filter","dueAt":"2026-07-01T09:00:00.000Z","recurrence":{"unit":"month","interval":3,"anchor":"completion"}}'
```
...
**Server-enforced:** `create_task` and `update_task` **reject** `todo` and `in_progress` tasks without `dueAt`. Use `status: "backlog"` (or `blocked`) for genuine someday items with no deadline.
...
kairos call create_task '{"title":"Pick a template","projectId":"<uuid>","milestoneId":"<uuid>","dueAt":"2026-07-20T17:00:00.000Z"}'
